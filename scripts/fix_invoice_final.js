...
// Locate buildInvoiceHTML start and end (next top-level function or EOF)
const fnStart = src.indexOf('\nasync function buildInvoiceHTML(')
if (fnStart < 0) { console.error('buildInvoiceHTML not found'); process.exit(1) }

// Find matching end: search for next '\nfunction ' or '\nasync function ' after fnStart+10, else EOF
...
console.log('buildInvoiceHTML rebuilt cleanly - all font sizes reduced by 1pt')
