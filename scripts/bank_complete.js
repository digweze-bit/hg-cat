...
// 4. Update InvoiceDetail signature + add bank state
mustReplace(
...
// 8. Update both calls to buildInvoiceHTML to pass selectedBank
// printInvoice call
mustReplace(
...
// 9. Add bank details to printed invoice footer
mustReplace(
...
console.log('ALL 9 PATCHES APPLIED SUCCESSFULLY')
